...
public sealed class OAuthOptions
{
    ...
    /// <summary>Endpunkt, an dem Code gegen Token getauscht und erneuert wird.</summary>
    public Uri TokenEndpoint { get; init; } = new("https://console.anthropic.com/v1/oauth/token");
