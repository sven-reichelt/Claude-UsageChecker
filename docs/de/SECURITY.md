...
*English version: [SECURITY.md](../../SECURITY.md) – das ist die maßgebliche
Fassung; weicht diese hier ab, gilt die englische.*
...
Ein Test (`ToString_DoesNotGiveAwayTheTokenValue`) sichert das ab.
